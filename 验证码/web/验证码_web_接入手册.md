...
| lang | string | 否 | zh-cn（简体中文） | 模式：支持zh-cn（简体中文）、en（英文）、ph（菲律宾语）、ina（印尼语）、tha（泰语）、vn（越南语）、mys（马来语）、jp（日语）、kr(韩语)、西班牙语（es）、孟加拉语（bn）、葡萄牙语（pt）、德语（de）、法语（fr）、印地语（hi）、意大利语（it）、乌尔都语（ur）、俄语（ru）、瑞典语（sv）、土耳其语（tr）、中文繁体 （zh-tw）、阿拉伯语（ar）。成语语序和文字点选只支持中文。 |
